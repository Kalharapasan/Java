...
class Subclass_1 implements  Interface_1{
...
class Subclass_2 implements Interface_2{
...
public class Main{
    public static void main(String []args){
        ...
        Subclass_1 sub1= new Subclass_1();
        sub1.Interface1_method1();
        sub1.Interface1_method2();

        //Create the Object and call method Interface_2
        Subclass_2 sub2= new Subclass_2();
        sub2.Interface2_method1();
        sub2.Interface2_method2();
    }
}
